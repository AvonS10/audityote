...
/**
 * Icon — a single line icon from the ControlMap set (Lucide-derived: 24px grid, 2px stroke,
 * round caps/joins). Ported from the design system's Icon component. No emoji, ever — line icons
 * only, inheriting currentColor.
 */
const PATHS = {
